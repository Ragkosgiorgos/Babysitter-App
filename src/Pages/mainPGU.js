    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      <div style={{ flex: 1,overflowY: "auto" }}>
        <div style={{display: "flex",justifyContent:"center"}}>
          <img style={{marginRight:"8px"}} src="/logo192.png" width="100" height="100"  alt="" />  
        </div>
        <div style={{display:"flex",width:"50%", justifyContent:"center", margin: "0 auto", flexDirection:"column",border: "1px solid black",borderTopLeftRadius: "15px",borderTopRightRadius: "15px",borderBottomLeftRadius: "15px",borderBottomRightRadius: "15px",height: "20vh"}}>
        ...
        <div style={{marginTop:"20px",marginLeft:"20px"}}>
          <h6 >Δείτε ενδεικτικές αγγελίες για εργασία</h6>
