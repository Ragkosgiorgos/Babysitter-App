            ...
            <div style={{ flex: 1, overflowY: "auto" }}>
                ...
                <div>
                    ...
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                        <span style={{width:"80%"}} >
                        Για να βρείτε τον/την επαγγελματία που σας ταιριάζει θα πρέπει να ολοκληρώσετε τα εξής βήματα:
                            <br />
                            <ul style={{listStyleType:"disc"}}>
                            <li>Βεβαιωθείτε ότι πληρείτε τα κριτήρια επιλεξιμότητας και εγγραφείτε στο πρόγραμμα.</li>
                            <li>Βρείτε τον/την επαγγελματία που σας ταιριάζει.</li>
                            <li>Κάντε μία αίτηση ενδιφέροντος συνεργασίας και κανονίστε ένα ραντεβού (διαδικτυακά ή δια ζώσης) με τον/την επαγγελματία της επιλογής σας.</li>
                            <li>Υπογράψτε μέσω της πλατφόρμας μας ένα συμφωνητικό συνεργασίας.</li>
                            <li>Στο τέλος κάθε μήνα, επιβεβαιώστε την ολοκλήρωση της μηνιαίας συνεργασίας με τον/την επαγγελματία ώστε να καταβληθεί αυτόματα το αντίστοιχο voucher.
                            </li>
                            </ul>
                        </span>
                        </Accordion.Body>
                ...
                <div>
                    ...
                    <Accordion.Item eventKey="0">
                        ...
                        <span style={{width:"80%"}} >
                            <br />
                            <ul style={{listStyleType:"disc"}}>
                            <li style={{fontWeight:"bold"}}>Χρειάζεται να καταβάλλω κάποιο μέρος της πληρωμής του επαγγελματία;</li>
                            <p>- Όχι, η πληρωμή γίνεται εξ ολοκλήρου από τη πλατφόρμα μέσω πίστωσης voucher στον επαγγελματία. </p>
                            ...
                            στον/ην επαγγελματία.</p>
                            <li style={{fontWeight:"bold"}}>Μπορώ να συνεργάζομαι ταυτόχρονα με πολλούς επαγγελματίες;</li>
                            <p>- Μπορείτε να συνεργαστείτε μόνο με εναν επαγγελματία ανά κάθε χρονική στιγμή. Παρόλα αυτά, όσο έχετε ενεργά συμβόλαια μπορείτε να προγραμματίσετε
                            τις επόμενες συνεργασίες σας.</p>
                            <li style={{fontWeight:"bold"}}>Μπορώ να συνεργαστώ με κάποιον επαγγελματία για να προσέχει και τα δύο (ή περισσότερα) παιδιά μου;</li>
                            <p> - Όχι, κάθε επαγγελματίας έχει ευθύνη για ένα και μόνο παιδί, ακόμη και αν αφορά το ίδιο συμβόλαιο / την ίδια οικογένεια.</p>
                            <li style={{fontWeight:"bold"}}>Πως πραγματοποιείται το ραντεβού με τον επαγγελματία;</li>
                            <p> - Το ραντεβού γνωριμίας με τον επαγγελματία μπορεί να γίνει είτε διαδικτυακά είτε δια ζώσης.</p>
                            <li style={{fontWeight:"bold"}}>Οι ημέρες και ώρες εργασίας ορίζονται εγγράφως;</li>
                            <p>- Οι ημέρες και ώρες εργασίας του επαγγελματία ορίζονται αυστηρά στο συμβόλαιο που υπογράφεται και από τις δύο πλευρές και καθορίζει αυστηρά την 
                            πληρωμή του επαγγελματία.</p>
